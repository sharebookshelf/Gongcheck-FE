    ...
    <>
      <div className="flex flex-row items-center justify-between w-full gap-4 mb-4">
        <Button
          ...
          className="flex items-center space-x-2 bg-orange-400 px-4 py-2 rounded-full hover:bg-orange-600"
          disabled={isFetching}
        >
          <ThumbsUpIcon className="text-white" />
          <span className="font-medium text-white">공감해요!</span>
          <SmileIcon className="text-white" />
        </Button>
        <Button
          onClick={() => openFeedbackDialog("n")}
          className="flex items-center space-x-2 bg-gray-200 px-4 py-2 rounded-full hover:bg-gray-400"
          disabled={isFetching}
        >
          <ThumbsDownIcon className="text-black" />
          <span className="font-medium text-[#333333]">아니에요</span>
          <FrownIcon className="text-black" />
        </Button>
      </div>
